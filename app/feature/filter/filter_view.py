import numpy as np
from app.feature.filter.filters import lowpass_filter
from app.shared.view_helpers import create_plot_widget
from app.ui.generated.filter_window import Ui_FilterWindow
